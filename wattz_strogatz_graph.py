...
def visualize_graph(G, colors):
    ...
    nx.draw_networkx(G,pos, with_labels=True, node_color=node_color_list, cmap=plt.cm.rainbow)
    plt.show()
...
def main():
    ...
    G = nx.watts_strogatz_graph(num_nodes,4, edge_prob)
